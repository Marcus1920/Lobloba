...
namespace Food__For__us.ViewModels.Buyers
{
   public class DeleteChatViewModel : INotifyPropertyChanged
    {
        ...
        public DeleteChatViewModel(INavigation MainPageNav)
